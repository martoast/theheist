    ...
    <b-container class="p-3">
      ...
      <div class="about text-white">
        ...
        <p>
          ...
          governed by the THG (The Heist Group)
        </p>
        ...
        <h3>Are these identities rare?</h3>
        <p>
        ...
        <h3>How much does an Identity cost?</h3>
        ...
        <h3>How can I get a Heist Identity?</h3>
        <p>
        ...
        <h3>How do I actually purchase a Heist Identity?</h3>
        <p>
        ...
        <h3>What can we use the identity for?</h3>
