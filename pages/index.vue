<template>
   <div style="background-color: #000 !important">
         ...
         <div>
            <b-card-group class="d-none d-md-block" columns>
               <b-card
                  ...
                  ></b-card>
               <b-card
                  img-src="/images/gallery/7846.png"
                  img-alt="Image"
                  class="border-0"
                  overlay
                  ></b-card>
               <b-card
                  img-src="/images/gallery/7812.png"
                  img-alt="Image"
                  class="border-0"
                  overlay
                  ></b-card>
               <b-card
                  ...
                  ></b-card>
               <b-card
                  img-src="/images/gallery/8061.png"
                  img-alt="Image"
                  class="border-0"
                  overlay
                  ></b-card>
               <b-card
                  img-src="/images/gallery/4741.png"
                  img-alt="Image"
                  class="border-0"
                  overlay
                  ></b-card>
               <b-card
                  img-src="/rocketgirl.jpeg"
                  img-alt="Image"
                  class="border-0"
                  overlay
                  ></b-card>
               <b-card
                  img-src="/images/gallery/1356.png"
                  img-alt="Image"
                  class="border-0"
                  overlay
                  ></b-card>
    ...
    >
      ...
      <b-container fluid class="py-3 py-md-5  text-white text-center">
         <b-row align-v="center">
            <b-col  cols="12" md="6" sm="12">
               ...
               <p style="font-family: 'Champange'; font-size: 22px" class="px-2 px-md-5">
               ...
               <p style="font-family: 'Champange'; font-size: 22px" class="px-2 px-md-5">Welcome to The Heist.</p>
               <p class="px-5">
      ...
      <b-container fluid class="d-none d-md-block py-5 px-0 px-md-5 text-white">
         <b-row align-v="center">
            <b-col  cols="12" md="6" sm="12">
               <b-card
                  img-src="/gasstation.jpg"
                  img-alt="Image"
                  class="border-0"
                  overlay
                  ></b-card>
            ...
            <b-col class="py-5"  cols="12" md="6" sm="12">
               ...
               <p style="font-family: 'Champange';" class="px-2 px-md-3">
                  They hit Atlantic City to hide all of the money they've collected… This is where The Heist Group was born.
A committee of all women that broke free from the rules of society, from poverty, and the strict laws of their Government.
               </p>
               <p style="font-family: 'Champange';" class="px-2 px-md-3">
...
A committee of all women that broke free from the rules of society, from poverty, and the strict laws of their Government.
      ...
      <b-row align-h="center" class="text-center">
        <b-col>
          <h1 class="text-white" style="font-family: 'Market'; font-size: 42px;">THE HEIST ROADMAP</h1>
        </b-col>
      </b-row>
      <h1 class="title text-white text-center" style="font-family: 'Market'; font-size: 42px;">PHASE 01</h1>
      <div class="about text-white pt-2 pt-md-4">
        <h1 style="font-family: 'Market'; font-size: 42px;">Q1 2022</h1>
        <div style="font-family: 'Champange';">
           <p>● Project Launch ✅</p>
        <p>● Begin organic community development</p>
        <p>● Early Community Pre-Sale ✅</p>
        <p>● New Web platform launch ✅</p>
        <p>● Recruitment of professionals to join administrative team ✅</p>
        <p>● Team Reveal ✅</p>
        <p>● Rewards for OG and Early Holders dispersed ✅</p>
        <p>● Periodic AMA’s begin, schedules to be announced in Discord ✅</p>
        <p>
          ● 0.5 ETH Private Sale for Legendary 1/1 Giveaway – end of March ✅
        </p>
        <h1 style="font-family: 'Market'; font-size: 42px;">Q2 2022</h1>
        <p>● Begin professional marketing campaigns ✅</p>
        <p>● List project on NFT Calendar ✅</p>
        <p>● Get listed on Rarity.tools</p>
        <p>● 3D model First Metaverse Heist Lounge for Discord Community</p>
        <p>● .05 ETH Public Sale of Genesis Collection begins!</p>
        <p>● Merch design development/consultation with manufacturer</p>
        <p>● First scenes of the The Heist Comic shall be released</p>
        <h1 style="font-family: 'Market'; font-size: 42px;">Q3 2022</h1>
        <p>● Continuation of rewards for active community members</p>
        <p>
          ● Launch first Heist Metaverse Lounge room to host Community events
        </p>
        <p>● Release further promotional content to grow community</p>
        <p>● Launch first merch bundle to holders only</p>
        <p>● Close public sale</p>
        <p>● Generate next installment of Heist Lounge</p>
        <p>● Release new scenes of The Heist Comic saga</p>
